...
class Test_5_CancelTransactionCommandHandlerTest {
    ...
    class Handle {
        @Test
        void should_return_CancelTransactionSucceeded_when_transaction_canceled() {
        ...
        @Test
        void should_return_CancelTransactionFailed_when_transaction_not_canceled() {
            var command = new CancelTransactionCommand(TRANSACTION_ID, CART_ID, AMOUNT);
