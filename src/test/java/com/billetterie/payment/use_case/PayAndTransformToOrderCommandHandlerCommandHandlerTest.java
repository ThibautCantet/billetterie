...
class PayAndTransformToOrderCommandHandlerCommandHandlerTest {
    ...
    @Spy
    @InjectMocks
    private CancelTransactionCommandHandler cancelTransactionHandler;

    @Spy
    @InjectMocks
    private AlertTransactionFailureHandler alertTransactionFailureHandler;
    ...
    public void should_return_failed_and_cancel_transaction_when_payment_success_but_transform_to_order_fails() {
        ...
        verify(cancelTransactionHandler).handle(new CancelTransactionCommand(TRANSACTION_ID, CART_ID, AMOUNT));

        verify(bank).cancel(TRANSACTION_ID, AMOUNT);

        verify(alertTransactionFailureHandler, never()).handle(any());
    ...
    public void should_return_failed_and_alert_when_payment_success_but_transform_to_order_fails_and_cancel_transaction_fails() {
        ...
        verify(alertTransactionFailureHandler).handle(new AlertTransactionFailureCommand(TRANSACTION_ID, CART_ID, AMOUNT));
